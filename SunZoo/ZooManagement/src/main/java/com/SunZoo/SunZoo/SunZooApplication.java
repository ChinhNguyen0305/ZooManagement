			...
			if (account.equals("admin") && pwd.equals(pwd)) {
				...
				do {
					...
					case 2: {
						...
						// hard coded this into 2 patter, only1 animal, and if 2, that must be 1 lion and
						// 1 dolphin
...
//						int selectedCage = scanner.nextInt();
						SunZoo.addAnimaltoCage(new Lion("the King", 3000),2);
